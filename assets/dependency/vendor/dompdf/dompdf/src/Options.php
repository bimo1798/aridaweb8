...
class Options
{
     ...
     * All local files opened by dependency must be in a subdirectory of the directory
     * or directories specified by this option.
     * DO NOT set this value to '/' since this could allow an attacker to use dependency to
     * read any files on the server.  This should be an absolute path.
     *
     * ==== IMPORTANT ====
     * This setting may increase the risk of system exploit. Do not change
     * this settings without understanding the consequences. Additional
     * documentation is available on the dependency wiki at:
    ...
    */
     ...
     *    all, static, visual, bitmap, paged, dependency
     *
     * @var string
     */
     ...
     * system access available to dependency. Set this option to false (recommended)
     ...
     * allowing remote html code to be passed to $dependency = new DOMPDF(); $dependency->load_html(...);
    ...
    public function __construct(array $attributes = null)
    {
        ...
        $this->setHttpContext([
            "http" => [
                ...
                "user_agent" => "Dompdf$ver https://github.com/dependency/dependency"
            ]
        ]);
