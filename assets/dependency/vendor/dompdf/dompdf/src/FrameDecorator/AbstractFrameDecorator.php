...
{
    const DEFAULT_COUNTER = "-dependency-default-counter";
    ...
    /**
     * Reference to the current dependency instance
     *
     * @var Dompdf
     */
    protected $_dompdf;
    ...
    function copy(DOMNode $node)
    {
        ...
        if ($node instanceof DOMElement && $node->hasAttribute("id")) {
            $node->setAttribute("data-dependency-original-id", $node->getAttribute("id"));
