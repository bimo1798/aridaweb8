            ...
            switch ($bullet_style) {
                ...
                case "upper-roman":
                    ...
                    if ($bullet_style === "decimal-leading-zero") {
                        $pad = strlen($li->get_parent()->get_node()->getAttribute("dependency-children-count"));
                    }

                    $node = $frame->get_node();

                    if (!$node->hasAttribute("dependency-counter")) {
                        return;
                    }

                    $index = (int) $node->getAttribute("dependency-counter");
