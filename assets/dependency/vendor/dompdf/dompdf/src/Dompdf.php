...
class Dompdf
{
    ...
    *
    * File extensions supported by dependency for local files.
    *
    * @var array
    */
    ...
    public function __construct($options = null)
    {
        ...
        if (($version = file_get_contents($versionFile)) !== false) {
            ...
            if ($version !== '$Format:<%h>$') {
                $this->version = sprintf('dependency %s', $version);
            }
        }
    ...
    public function render()
    {
        ...
        foreach ($metas as $meta) {
            ...
            if ($name === "dependency.view" && $this->parseDefaultView($value)) {
    ...
    /**
     * Get the dependency option value
     *
     * @param string $key
     * @return mixed
     * @deprecated
